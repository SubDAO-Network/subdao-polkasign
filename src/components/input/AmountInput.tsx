...
export const AmountInput: React.FC<AmountInputProps> = ({
  ...
  return (
    <div className="mb-3 custom-amount-input">
      <div className="flex flex-row items-center justify-between mb-3">
        <label className="flex-1 text-sm">{title}</label>
        {!!maxValue && (
          <PercentButton
      ...
      <div
        className={classNames(
          'flex flex-row items-center rounded-lg border mt-7',
          {
      ...
      >
        <NumberFormat
          thousandSeparator
          className={classNames(
            'flex-1 p-4 appearance-none w-full outline-none focus:outline-none text-black bg-transparent custom-input',
            {
        ...
        <button
          ...
          disabled={disabled}
        >
          {/* <CIcon symbol={tokenSymbol} icon={CIcon} size="30" /> */}
          <div
