...
const useTooltip = (
  ...
  const tooltip = (
    <div
      className="tooltip-container z-20 max-w-tooltip rounded p-3 text-xs leading-snug text-black whitespace-no-wrap bg-white shadow-lg"
    ...
    >
      ...
      <div
        ...
        style={styles.arrow}
      >
        <div className="w-2 h-2 transform rotate-45 bg-white" />
      </div>
    </div>
  )
  let tooltipInPortal = null
  useEffect(() => {
    tooltipInPortal = createPortal(
      tooltip,
